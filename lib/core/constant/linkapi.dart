class AppLink {
  ...
  static const String linksginupasprovider =
      "$linkservername/auth/sign_up_provider.php";
  static const String linkloginwithnumber =
  ...
  static const String linkofcategoryservices =
      "$linkservername/categoryservices.php";
  static const String linkofshowallproviders =
      "$linkservername/showallproviders.php";
  static const String linkofproviderinfo = "$linkservername/providerinfo.php";
  static const String linkofchangepassword =
      "$linkservername/update/updatepassword.php";
  static const String linkofchangeusername =
      "$linkservername/update/updateusername.php";
  static const String linkofchangeuseremail =
